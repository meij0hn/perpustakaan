<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('admin.borrow.index') }}"><i class="fa fa-bookmark"></i> <span>Buku Sedang Dipinjam</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('admin.report.top-user') }}"><i class="fa fa-circle-o"></i>Peminjam Teraktif</a></li>
          </ul>
        </li>
